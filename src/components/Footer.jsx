            ...
            <div className="w-full -mx-6 lg:w-2/5">
              <div className="px-6">
                <div className="flex items-center gap-5">
                  ...
                  <h1 className="font-bold text-xl">Volunify Hub</h1>
                </div>
                ...
                <div className="flex mt-6 -mx-2">
                  <a
                    href="#"
                    className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-600"
                    aria-label="Reddit"
                  >
                    <svg
